...
The easiest way to get started is to initialize a new project. Pin a specific release tag for stability (check [Releases](https://github.com/nhanvonguyen-infotrack/spec-kit/releases) for the latest):

```bash
# Install from a specific stable release (recommended — replace vX.Y.Z with the latest tag)
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <PROJECT_NAME>

# Or install latest from main (may include unreleased changes)
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git specify init <PROJECT_NAME>
```

Or initialize in the current directory:

```bash
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init .
# or use the --here flag
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init --here
```
...
```bash
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <project_name> --ai claude
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <project_name> --ai gemini
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <project_name> --ai copilot
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <project_name> --ai codebuddy
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <project_name> --ai pi
```
...
```bash
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <project_name> --script sh
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <project_name> --script ps
```
...
```bash
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init <project_name> --ai claude --ignore-agent-tools
```
