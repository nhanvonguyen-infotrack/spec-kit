...
| ----------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| **CLI Tool Only** | `uv tool install specify-cli --force --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z` | Get latest CLI features without touching project files        |
...
Upgrade to a specific release (check [Releases](https://github.com/nhanvonguyen-infotrack/spec-kit/releases) for the latest tag):
...
```bash
uvx --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git@vX.Y.Z specify init --here --ai copilot
```
...
uv tool install specify-cli --force --from git+https://github.com/nhanvonguyen-infotrack/spec-kit.git
...
- **Review release notes:** Check [GitHub Releases](https://github.com/nhanvonguyen-infotrack/spec-kit/releases) for new features and breaking changes
